...
@objc open class AUIUserLocalServiceImpl: NSObject {
...
extension AUIUserLocalServiceImpl: AUIRtmUserProxyDelegate {
...
extension AUIUserLocalServiceImpl: AUIUserServiceDelegate {
...
extension AUIUserLocalServiceImpl {
    //设置用户属性到presence
