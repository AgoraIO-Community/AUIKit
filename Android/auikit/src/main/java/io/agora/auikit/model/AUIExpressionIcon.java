...
public class AUIExpressionIcon {
    public AUIExpressionIcon(){
    }
     ...
     */
    public AUIExpressionIcon(int icon, String label){
        this.icon = icon;
        this.label = label;
     ...
     * @param type - normal
     */
    public AUIExpressionIcon(int icon, String label, Type type){
        this.icon = icon;
        this.label = label;
        this.type = type;
    }
