...
import io.agora.auikit.ui.chatList.listener.AUIStatusChangeListener

class AUIBroadcastMessageView : AppCompatTextView,IAUIChatListView{
    ...
    private var listener: AUIStatusChangeListener? = null
    ...
    fun setSubtitleStatusChanged(listener: AUIStatusChangeListener){
